...
/*
    ...
    Procedure:
        1. Stworzyć nowy obiekt Approximation z argumentami (tablica vector double wielkości macierzy rownan, tablica vector double czasy wykonan, int stopień_wielomianu)
        2. nowa_aproksymacja.create_polynominal() <--tworzy wielomian

        Teraz można:
        a) wypisac wielomian (to_string lub print)
        b) obliczyć wielomian dając x - > nowa_aproksymacja.solve(int wielkosc_plaszy);
